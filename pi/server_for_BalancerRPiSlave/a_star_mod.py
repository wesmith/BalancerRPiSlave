...
# a_star_mod.py modified from a_star.py, WESmith 12/22/19
# this mod adds method write_y_gyro_rate(); not that Data struct in Balboa-LSM6-RPi.ino must
# be modified to include this change;
# methods below also re-ordered in same order as Data struct
...
class AStar:
  ...
  def write_y_gyro_rate(self, y_gyro_rate):  # WS
    self.write_pack(43, 'h', y_gyro_rate)
