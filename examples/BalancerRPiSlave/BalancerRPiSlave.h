...
const int16_t ANGLE_RATE_RATIO = 140;  // default 140
...
const int16_t ANGLE_RESPONSE = 15;  // original 11
...
const int16_t DISTANCE_RESPONSE = 75;  // original 73
...
const int16_t SPEED_RESPONSE = 2500;  // original 3300
